...
% output: subject information table
file_subInfo_OAIZIB = 'path/to/OAIZIB_subject_info.xlsx';
% =============================================================
...
% create empty table
var_out = [{'SubjectID'},{'Path'},{'MRBarCode'},{'KneeSide'},{'KLGrade'},{'Gender'},{'Age'},{'BMI'}];
...
%% Save to xlsx file
writetable(table_out, file_subInfo_OAIZIB, ...
    "FileType", "spreadsheet", ...
