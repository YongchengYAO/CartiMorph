...
# registration model
# e.g. path_model='~/Documents/CartiMorph/Models_training/vxm/vxm_models/regModel/LNCC_x2/1000.h5'
export path_model='path/to/model/file' 

# [Logging] 
export log_file='path/to/log/file/predicting_getField_LNCC_x2.log' 
