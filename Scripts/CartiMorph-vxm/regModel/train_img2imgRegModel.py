...
parser.add_argument('--reg-field', default='svf', help='the target of field regularization: svf or deformation')
...
# build the model
if args.reg_field=='svf':
    reg_field='preintegrated'
elif args.reg_field=='deformation':
    reg_field='warp'
...
if nb_devices > 1:
    ...
    model = keras.utils.multi_gpu_utils.multi_gpu_model(model, gpus=nb_devices)
else:
