function cropRangeInfo = CM_imgPreprocess_mdcn_fixedDownFactor(dir_seg_in, dir_img_in, dir_seg_out, dir_img_out,...
    imgSize_out, kneeSizeInfo, factor)
% -----------------------------------------------
% m: mask
% d: downsample
% c: crop
...
for i=1:numCase
    ...
    % ===============================================================
    % [2] use the specified downsampling factor
    % ===============================================================
