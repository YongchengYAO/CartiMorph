function faces_out = CM_cal_deleteLargeComponents(components, threshold)
% ==============================================================================
% FUNCTION:
%     Delete large mesh components.
%
% INPUT:
%     - components: mesh component
%     - threshold: size threshold above which the (large) components will be removed
%
% OUTPUT:
